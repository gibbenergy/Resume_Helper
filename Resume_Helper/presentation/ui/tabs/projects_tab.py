...
def create_projects_tab(resume_helper):
    with gr.Tab("Projects") as tab:
        ...
        with gr.Row():
            title_in = gr.Textbox(label="Project Title", lines=2, interactive=True)
            url_in = gr.Textbox(label="URL", lines=2, interactive=True)
        ...
        tech_in = gr.Textbox(label="Technologies", lines=2, interactive=True)
